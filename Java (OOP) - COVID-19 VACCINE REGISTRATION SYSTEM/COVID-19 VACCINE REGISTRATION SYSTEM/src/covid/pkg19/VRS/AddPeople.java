...
public class AddPeople extends JFrame implements ActionListener{
    public void actionPerformed(ActionEvent e){
        if(e.getSource() == ShowPass){
            ...
            if(Name.equals(def) || IDno.equals(def) || Address.equals(def) || State.equals(def) ||
                ...
                JOptionPane.showMessageDialog(null, "IC/Passport No. cannot contain characters and symbol!");
                ...
                if(COVID19VRS.comtPeopleInfo.flag){
                    ...
                    COVID19VRS.comtPeopleInfo.model.addRow(new Object[]{c.getIDnumber(),c.getName(),Nationality,c.getBirthDate(),c.getAge(),
                        c.getGender(),c.getAddress(),c.getState(),c.getPhoneNumber(),c.getEmail()}); 
    ...
    private String[] days, months, years, states;
    public AddPeople(){
        setSize(650, 350);
        ...
        title = new Label("New People Account", Label.CENTER);
